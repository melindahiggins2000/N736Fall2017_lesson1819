...
We'll look at this function over X's ranging from -10 to 10 and we'll look at each step in between by computing the Logit, Odds and Probability and then we'll make a plot of each one.
...
### Table of X, Logit, Odds, Probability (excerpt for X=-1.1. to 0.9)
